  ...
  render() {
    return (
      <div id='homepage-container'>
        <Button bsStyle='deepred' className='btn-auth btn-login' style={{marginRight: 150}} outlined onClick={::this.handleLogin}>Log in</Button>
        <Button bsStyle='deepred' className='btn-auth btn-signup' style={{marginRight: 30}} outlined onClick={::this.handleSignup}>Sign up</Button>
        <div>
